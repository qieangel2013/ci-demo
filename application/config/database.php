...
$_master_slave_relation = array(
    'default' => array('default_slave'),
);

$db['default']['hostname'] = '192.168.1.212';
$db['default']['port'] = '3306';
$db['default']['username'] = 'www';
$db['default']['password'] = 'jixiang';
$db['default']['database'] = 'jixiang';
...
$db['default_slave']['hostname'] = '192.168.1.213';
$db['default_slave']['port'] = '3306';
$db['default_slave']['username'] = 'www';
$db['default_slave']['password'] = 'jixiang';
$db['default_slave']['database'] = 'jixiang';
...
$db['default_slave']['autoinit'] = TRUE;
